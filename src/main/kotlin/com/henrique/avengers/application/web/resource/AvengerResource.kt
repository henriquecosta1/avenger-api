package com.henrique.avengers.application.web.resource

import com.henrique.avengers.application.web.resource.request.AvengerRequest
import com.henrique.avengers.application.web.resource.response.AvengerResponse
import com.henrique.avengers.domain.avenger.AvengerRepository
...
class AvengerResource (
    ...
    @GetMapping
    fun getAvenger() = repository.getAvengers()
